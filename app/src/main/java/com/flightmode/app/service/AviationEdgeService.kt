...
interface AviationEdgeService {
    ...
    companion object {
        private const val PATH_NEARBY = "/api/public/nearby"
        private const val PATH_TIMETABLE = "/api/public/timetable"
        private const val PATH_CITY_DATABASE = "/api/public/cityDatabase"
